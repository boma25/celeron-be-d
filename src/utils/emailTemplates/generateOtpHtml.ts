                              ...
                              <tr>
                                <td class="pad" style="text-align: center">
                                  <div align="center" class="alignment">
                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:82px;width:63px;v-text-anchor:middle;" arcsize="5%" stroke="false" fillcolor="#f8f8f8"><w:anchorlock/><v:textbox inset="5px,0px,0px,0px"><center style="color:#000; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
                                    <div
                                      style="
                                        text-decoration: none;
                              ...
                              <tr>
                                <td class="pad">
                                  <div align="left" class="alignment">
                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:42px;width:132px;v-text-anchor:middle;" arcsize="24%" stroke="false" fillcolor="#151515"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
