-- DropForeignKey
ALTER TABLE `ShipmentHistory` DROP FOREIGN KEY `ShipmentHistory_orderId_fkey`;
...
-- CreateIndex
CREATE UNIQUE INDEX `OrderProduct_productId_key` ON `OrderProduct`(`productId` ASC);
...
-- CreateIndex
CREATE INDEX `Transaction_cardId_fkey` ON `Transaction`(`cardId` ASC);
